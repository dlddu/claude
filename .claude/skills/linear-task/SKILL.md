...
allowed-tools: mcp__linear-server__get_issue, mcp__linear-server__get_attachment, mcp__linear-server__extract_images, mcp__linear-server__create_comment, Task, Bash, TodoWrite, WebSearch, Read
---
